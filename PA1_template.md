...
So i will be using a flip coin model with probability vector set to return 
either the floor(mean) or ceiling(mean) with corresponding probabilities

I will use next strategy for filling NAs values for steps:  
