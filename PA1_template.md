...
- get the mean for a specific interval  
- get the number of all NAs for a specific interval  
- build a normal distribution and get a vector with length equal to missing NAs 
number for that interval  
- replace all NAs with values from the vector obtained from the normal distribution  
